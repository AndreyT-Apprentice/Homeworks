...
my_str = str("qwer")
my_str_result = my_str * 2 if len(my_str) < 5 else my_str
print(my_str_result)
...
my_str = str("qwer")
my_str_result = my_str + my_str[::-1] if len(my_str) < 5 else my_str
print(my_str_result)


######################################################################################################################
# 8) У вас есть переменная my_str, тип - str. Вывести на экран все символы из этой строки, которые являются буквой
# или цифрой.

my_str = str("qwerty 123 !@#$%^")
...
######################################################################################################################
# 9) У вас есть переменная my_str, тип - str. Вывести на экран все символы из этой строки, которые не являются буквой
# или цифрой.

my_str = str("qwerty 123 !@#$%^")
for symbol in my_str:
    if not (symbol.isalpha() or symbol.isnumeric()):
        print(symbol)


######################################################################################################################
# 10) У вас есть переменная my_str, тип - str. Вывести на экран все символы из этой строки, которые не являются буквой
# или цифрой и не пробел.

my_str = str("qwerty 123 !@#$%^")
for symbol in my_str:
    if not (symbol.isalpha() or symbol.isnumeric() or symbol.isspace()):
        print(symbol)
